function VideoLayer() {
	...
	function vl_init() {
		for(i=0;i<vl_maxnum;i++) {
			...
			vl_videoOnResize(i);
			if(!vl_video[i].controls) {
				vl_ui[i].presentationscreen.style.display = 'none';
				vl_ui[i].titles.style.display = 'none';
				vl_ui[i].menus.style.display = 'none';
				vl_ui[i].controls.style.display = 'none';
			}
			else vl_video[i].controls = false;
    ...
    function vl_addListeners(i) {
    	...
    	vl_ui[i].container.addEventListener('mousedown', function() {vl_getParameters(this);vl_getSecParameters(i);}, false);
    	vl_ui[i].container.addEventListener('mouseover', function() {vl_getParameters(this);vl_getSecParameters(i);vl_showUI(i);}, false);
